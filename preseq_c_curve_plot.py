#!/usr/bin/env python3
"""
Input folder with preseq c_curve result file, output plots.

Usage: python3 preseq_c_curve_plot.py --input --output
"""
...
# Part 1. Data Read in
###############################################################
input_files = glob.glob(input_path + "/" + "*.c_curve.txt")

input_data = {} # input_data[index] -> [sample name, read, mean]
index = 0
